...
| --- | --- | --- | --- |
| **[SafeBite](projects/safebite.md)** | Applied AI · OCR · LLM · Mobile/Backend | Hybrid rule-first screening pipeline, bilingual OCR, barcode lookup, conservative 3-state decisions, 22K+ product records | [Repository](https://github.com/Rawan806/safebite) |
...
- Annotated **200+ satellite images** under labeling and quality-check guidelines for downstream AI development.
- Contribute to an ongoing **KACST–MIT Jibo social robotics study**, currently focused on SEL literature review and structured behavioral measurement design.
...
[Read the SafeBite case study →](projects/safebite.md)
...
| **Analytics** | EDA, Data Cleaning, Feature Engineering, Model Evaluation, TF-IDF, Excel, Power BI, Apache Spark |
...
- Expanding applied AI experience through end-to-end product development.
- Building stronger research experience in human–robot interaction and behavioral data.
- Deepening practical ML evaluation, data quality, and deployment-oriented skills.
